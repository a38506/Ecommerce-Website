...
mongoose.connect("mongodb+srv://root:root@cluster0.bj9zq.mongodb.net/e-commerce");
...
// Creating endpoint for newcollecton data
app.get('/newcollection', async(req, res)=>{
    let products = await Product.find({});
    let newcollection = products.slice(1).slice(8);
    console.log("NewCollection Fectched");
    ...
    const fetchUser = async(req, res, next)=>{
        ...
        if (!token) {
            ...
            try {
                ...
                req.status(401).send({error:"please authenticate a valid token"})
            }
        }
    }

//Creating endpont for product in cartdata
